...
local_ip = "192.168.191.142" #Local nodes ip address (Node where the consensus runs)
...
coor_ip = "192.168.191.60"      #This is coordinator's ip address and its supposed to be entered as a string here
coor_port = 12345
        ...
        while True:
            ...
            if data:
                ...
                if message.get("init") == "INIT":
                    ...
                    path = f"/home/{user_name}/Desktop/Single_Pi_WiFi/"
