...
ns = {
    1: {"ip": "192.168.191.142", "port": 22, "user": "rasp1"},
    2: {"ip": "192.168.191.32", "port": 22, "user": "rasp6"},
    3: {"ip": "192.168.191.1", "port": 22, "user": "rasp7"},
    4: {"ip": "192.168.191.111", "port": 22, "user": "rasp8"}
}
...
if __name__ == "__main__":
    nodes = [("192.168.191.142",12345,1), ("192.168.191.32",12345,2), ("192.168.191.1",12345,3), ("192.168.191.111",12345,4)]   #Node information is stored in this list
    ...
    iteration_number = 50000  #Its upto the user to decide the number of iterations. More the iterations accurate are the results
    sleep_time = 0.025      #Sleep time has some constraints
    gaps = 100
    initiation = 5
